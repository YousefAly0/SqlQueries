...
SELECT prd.ep_id AS EpId, prd.ep_arabicName, prd.ep_englishName, price.markpr_current_price, img.ep_img_path, 
...
INNER JOIN excelproducts_images img ON img.ep_img_epid = prd.ep_id and img.ep_img_primary = 1 and img.ep_img_size = 1 -- make enum
...
WHERE market.market_id = 50 --dynamic
