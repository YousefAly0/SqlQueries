...
WHERE 1=1 AND (prd.ep_disable_pr_inapp = 0 OR prd.ep_disable_pr_inapp IS NULL) 

 ORDER BY rankTable.rank
OFFSET 0 ROWS
                                    FETCH NEXT 1000 ROWS ONLY;

									--7623175 in 50 with 51.00
									--7623175 in 1 with 60.00
									-- 7623253 in 50 with 42.00
									-- 7623253 in 1 with 65.95 "not exist"