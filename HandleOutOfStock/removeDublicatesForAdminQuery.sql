...
SELECT DISTINCT Count(*) OVER() AS TotalCount, prd.ep_id AS EpId, prd.ep_arabicName AS EpArabicName, prd.ep_englishName AS EpEnglishName,
							...
							OR market.market_id = multiplePrice.mph_market_id)
                             
            WHERE 1=1 AND (prd.ep_disable_pr_inapp = 0 OR prd.ep_disable_pr_inapp IS NULL) AND market.market_id = 1  	--AND price.markpr_market_id = 1 
